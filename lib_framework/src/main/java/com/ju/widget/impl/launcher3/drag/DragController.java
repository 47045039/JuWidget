...
public class DragController implements DragDriver.EventListener, TouchController {
    ...
    public DragController(Context context) {
        mLauncher = context;
        mFlingToDeleteHelper = new FlingToDeleteHelper(context);
    }
...
//            mDragObject.stateAnnouncer = DragViewStateAnnouncer.createFor(dragView);
        ...
        Launcher.getDragLayer(mLauncher).performHapticFeedback(HapticFeedbackConstants.LONG_PRESS);
...
//            mLauncher.getStateManager().goToState(NORMAL, SPRING_LOADED_EXIT_DELAY);
    ...
    private int[] getClampedDragLayerPos(float x, float y) {
        Launcher.getDragLayer(mLauncher).getLocalVisibleRect(mDragLayerRect);
