...
package com.ju.widget.celllayout;
...
import com.ju.widget.celllayout.compat.LauncherAppsCompat;
...
public class LauncherModel extends BroadcastReceiver
    ...
    public interface Callbacks {
        ...
        void bindAppsAdded(long newScreen, ArrayList<ItemInfo> addNotAnimated, ArrayList<ItemInfo> addAnimated,
                ArrayList<AppInfo> addedApps);
        void bindAppsUpdated(ArrayList<AppInfo> apps);
        void bindShortcutsChanged(ArrayList<ShortcutInfo> updated, ArrayList<ShortcutInfo> removed,
                UserHandleCompat user);
        void bindWidgetsRestored(ArrayList<LauncherAppWidgetInfo> widgets);
        void bindComponentsRemoved(ArrayList<String> packageNames, ArrayList<AppInfo> appInfos, UserHandleCompat user,
                int reason);
