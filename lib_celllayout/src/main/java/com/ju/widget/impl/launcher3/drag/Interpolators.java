...
import static com.ju.widget.impl.launcher3.Utilities.SINGLE_FRAME_MS;
...
public class Interpolators {
    ...
    public static class OvershootParams {
        ...
        public OvershootParams(float startProgress, float overshootPastProgress,
            ...
            Interpolator overshoot = Interpolators
                    .clampToProgress(DEACCEL, 0, overshootFraction);
            ...
            Interpolator settle = Interpolators
                    .clampToProgress(Interpolators.mapToProgress(
