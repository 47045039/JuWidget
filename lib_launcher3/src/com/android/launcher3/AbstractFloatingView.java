...
public abstract class AbstractFloatingView extends LinearLayout implements TouchController {
    ...
    public final void close(boolean animate) {
        ...
        if (mIsOpen) {
            LauncherDelegate.fromIBaseActivityContext(getContext()).getUserEventDispatcher()
    ...
    protected void announceAccessibilityChanges() {
        ...
        LauncherDelegate.fromBaseDraggingActivityContext(getContext()).getDragLayer()
    ...
    protected static <T extends AbstractFloatingView> T getOpenView(
            Launcher activity, @FloatingViewType int type) {
    ...
    public static void closeOpenContainer(Launcher activity,
    ...
    public static void closeOpenViews(Launcher activity, boolean animate,
                                      @FloatingViewType int type) {
        BaseDragLayer dragLayer = activity.getDragLayer();
        // Iterate in reverse order. AbstractFloatingView is added later to the dragLayer,
        // and will be one of the last views.
    ...
    public static void closeAllOpenViews(Launcher activity, boolean animate) {
        closeOpenViews(activity, animate, TYPE_ALL);
        activity.finishAutoCancelActionMode();
    }

    public static void closeAllOpenViews(Launcher activity) {
        closeAllOpenViews(activity, true);
    }

    public static AbstractFloatingView getTopOpenView(Launcher activity) {
        return getTopOpenViewWithType(activity, TYPE_ALL);
    }

    public static AbstractFloatingView getTopOpenViewWithType(Launcher activity,
                                                              @FloatingViewType int type) {
