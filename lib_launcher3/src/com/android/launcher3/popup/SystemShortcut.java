...
import com.android.launcher3.IBaseActivity;
import com.android.launcher3.IBaseDraggingActivity;
...
public abstract class SystemShortcut extends ItemInfo {
    ...
    public abstract View.OnClickListener getOnClickListener(Launcher activity, ItemInfo itemInfo);
    ...
    public static class AppInfo extends SystemShortcut {
        ...
        public View.OnClickListener getOnClickListener(
                Launcher activity, ItemInfo itemInfo) {
            return (view) -> {
    ...
    protected static void dismissTaskMenuView(Launcher activity) {
