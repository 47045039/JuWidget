...
public class WidgetPreviewLoader {
     ...
     * @return
     */
    public Bitmap generateWidgetPreview(IBaseActivity launcher, LauncherAppWidgetProviderInfo info,
    ...
    private Bitmap generateShortcutPreview(Launcher launcher, ShortcutConfigActivityInfo info,
    ...
    public class PreviewLoadTask extends AsyncTask<Void, Void, Bitmap>
        ...
        PreviewLoadTask(WidgetCacheKey key, WidgetItem info, int previewWidth,
            ...
            mCaller = caller;
            mActivity = LauncherDelegate.fromIBaseActivityContext(mCaller.getContext());
            if (DEBUG) {
