...
import static com.android.launcher3.Constant.INTENT_EXTRA_IGNORE_LAUNCH_ANIMATION;
...
import com.android.launcher3.LauncherDelegate;
...
public class OptionsPopupView extends ArrowPopup
    ...
    public static boolean onWidgetsClicked(View view) {
        return openWidgets(LauncherDelegate.getLauncher(view.getContext()));
    }
    ...
    public static boolean startSettings(View view) {
        Launcher launcher = LauncherDelegate.getLauncher(view.getContext());
    ...
    public static boolean startWallpaperPicker(View v) {
        Launcher launcher = LauncherDelegate.getLauncher(v.getContext());
